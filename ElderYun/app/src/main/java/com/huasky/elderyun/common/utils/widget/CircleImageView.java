...
/** 圆环头像
 * Created by pokermman on 16/5/12.
 */
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mShowFlag && mFlagText != null) {
            ...
            canvas.drawText(mFlagText, getWidth() / 2,
                    (float) ((3 + Math.cos( Double.parseDouble(String.valueOf((Math.PI * 5 / 18)))))
...
//           mBorderPaint.setColor(getResources().getColor(R.color.image_circle_color,null));
//       }else {
//           mBorderPaint.setColor(getResources().getColor(R.color.image_circle_color));
//       }
//
